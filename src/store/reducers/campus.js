...
================================================== */
import { ENROLL_STUDENT, FETCH_CAMPUS } from "../actions/actionTypes";  // Import Action Type
...
const campus = (state = initialState, action) => {  // Use "initialState" as default Initial State
  switch (action.type) {
    case FETCH_CAMPUS:
      ...
      case ENROLL_STUDENT:
        return {
          ...state, // Keep all other campus properties
          students: [...state.students, action.payload], // Add the new student to the campus's students array
        };
